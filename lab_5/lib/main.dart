...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    itemList = [
      ...
      ListViewItems('Perfect Peach', 'https://www.mariowiki.com/images/1/11/Peachy_Peach_PMTTYDNS_icon.png?9f32f', 'They don't look this good in real life!'),
      ...
      ListViewItems('Orange Juice', 'https://www.mariowiki.com/images/4/43/Fresh_Juice_PMTTYDNS_icon.png?4ba11', 'They put a slice on top so you know it's orange juice.'),
      ...
      ListViewItems('Spaghetti with Sauce', 'https://www.mariowiki.com/images/a/a3/Spaghetti_PMTTYDNS_icon.png?627a7', 'Just like Nonna's! Well, almost.'),
      ...
      ListViewItems('Halloween Candy', 'https://www.mariowiki.com/images/b/be/Honey_Candy_PMTTYDNS_icon.png?76868', 'No one will notice it's gone!'),
    ];
